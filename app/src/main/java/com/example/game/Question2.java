...
public class Question2 extends AppCompatActivity {
    ...
    final private  String r1 = "景";
    final private  String r2 = "照";
    final private  String r3 = "苔";

    private FrameLayout hole1;
    private FrameLayout hole2;
    private FrameLayout hole3;

    private static final String IMAGEVIEW_TAG1 = "景";
    private static final String IMAGEVIEW_TAG2 = "照";
    private static final String IMAGEVIEW_TAG3 = "苔";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question = findViewById(R.id.ZhuLiGuan);
    ...
    protected class mySubmitListener implements View.OnClickListener{
        ...
        public void onClick(View v){
            if(s1.equals(r1)&&s2.equals(r2)&&s3.equals(r3)){
                Toast.makeText(Question2.this, "Correct!", Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(Question2.this, "Wrong answer, please try again.", Toast.LENGTH_LONG).show();
            }
