...
public class Question4 extends AppCompatActivity {
    ...
    final private  String r1 = "会";
    final private  String r2 = "顶";
    final private  String r3 = "小";

    private FrameLayout hole1;
    private FrameLayout hole2;
    private FrameLayout hole3;

    private static final String IMAGEVIEW_TAG1 = "会";
    private static final String IMAGEVIEW_TAG2 = "顶";
    private static final String IMAGEVIEW_TAG3 = "小";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question = findViewById(R.id.WangYue);
    ...
    protected class mySubmitListener implements View.OnClickListener{
        ...
        public void onClick(View v){
            if(s1.equals(r1)&&s2.equals(r2)&&s3.equals(r3)){
                ...
                Toast.makeText(Question4.this, "Wrong answer, please try again.", Toast.LENGTH_LONG).show();
            }
    ...
    protected  class myPreviousListener implements  View.OnClickListener{
        @Override
        public void onClick(View v) {
            startActivity(new Intent(Question4.this,Question3.class));
            finish();
        }
    }
