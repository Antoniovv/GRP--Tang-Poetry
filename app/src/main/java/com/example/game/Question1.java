...
public class Question1 extends AppCompatActivity {
    ...
    final private  String r1 = "明";
    final private  String r2 = "月";
    final private  String r3 = "霜";

    private FrameLayout hole1;
    private FrameLayout hole2;
    private FrameLayout hole3;

    private static final String IMAGEVIEW_TAG1 = "月";
    private static final String IMAGEVIEW_TAG2 = "明";
    private static final String IMAGEVIEW_TAG3 = "霜";
...
//        Typeface face= Typeface.createFromAsset(mgr, "fonts/KaiTi.TTF");
        ...
        question = findViewById(R.id.JingYeSi);
    ...
    protected class mySubmitListener implements View.OnClickListener{
        ...
        public void onClick(View v){
            if(s1.equals(r1)&&s2.equals(r2)&&s3.equals(r3)){
                Toast.makeText(Question1.this, "Correct!", Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(Question1.this, "Wrong answer, please try again.", Toast.LENGTH_LONG).show();
            }
        }
    }
