...
public class Question9 extends AppCompatActivity {
    ...
    final private  String r1 = "逢";
    final private  String r2 = "歌";
    final private  String r3 = "碧";

    private FrameLayout hole1;
    private FrameLayout hole2;
    private FrameLayout hole3;

    private static final String IMAGEVIEW_TAG1 = "逢";
    private static final String IMAGEVIEW_TAG2 = "歌";
    private static final String IMAGEVIEW_TAG3 = "碧";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question = findViewById(R.id.XiJu);
    ...
    protected class mySubmitListener implements View.OnClickListener{
        ...
        public void onClick(View v){
            if(s1.equals(r1)&&s2.equals(r2)&&s3.equals(r3)){
                Toast.makeText(Question9.this, "Correct!", Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(Question9.this, "Wrong answer, please try again.", Toast.LENGTH_LONG).show();
            }
    ...
    protected  class myPreviousListener implements  View.OnClickListener{
        @Override
        public void onClick(View v) {
            startActivity(new Intent(Question9.this,Question8.class));
            finish();
        }
    }
    ...
    protected  class myNextListener implements  View.OnClickListener{
        @Override
        public void onClick(View v){
            startActivity(new Intent(Question9.this,Congratulation.class));
            finish();
        }
    }
