...
public class Question6 extends AppCompatActivity {
    ...
    final private  String r1 = "举";
    final private  String r2 = "邀";
    final private  String r3 = "影";

    private FrameLayout hole1;
    private FrameLayout hole2;
    private FrameLayout hole3;

    private static final String IMAGEVIEW_TAG1 = "举";
    private static final String IMAGEVIEW_TAG2 = "邀";
    private static final String IMAGEVIEW_TAG3 = "影";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question = findViewById(R.id.YueXiaDuZhuo);
    ...
    protected class mySubmitListener implements View.OnClickListener{
        ...
        public void onClick(View v){
            if(s1.equals(r1)&&s2.equals(r2)&&s3.equals(r3)){
                Toast.makeText(Question6.this, "Correct!", Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(Question6.this, "Wrong answer, please try again.", Toast.LENGTH_LONG).show();
            }
    ...
    protected  class myPreviousListener implements  View.OnClickListener{
        @Override
        public void onClick(View v) {
            startActivity(new Intent(Question6.this,Question5.class));
            finish();
        }
    }
