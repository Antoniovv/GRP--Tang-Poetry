...
public class Question3 extends AppCompatActivity {
    ...
    final private  String r1 = "君";
    final private  String r2 = "归";
    final private  String r3 = "时";

    private FrameLayout hole1;
    private FrameLayout hole2;
    private FrameLayout hole3;

    private static final String IMAGEVIEW_TAG1 = "君";
    private static final String IMAGEVIEW_TAG2 = "归";
    private static final String IMAGEVIEW_TAG3 = "时";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question = findViewById(R.id.Chunsi);
    ...
    protected class mySubmitListener implements View.OnClickListener{
        ...
        public void onClick(View v){
            if(s1.equals(r1)&&s2.equals(r2)&&s3.equals(r3)){
                Toast.makeText(Question3.this, "Correct!", Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(Question3.this, "Wrong answer, please try again.", Toast.LENGTH_LONG).show();
            }
