...
public class Question8 extends AppCompatActivity {
    ...
    final private  String r1 = "月";
    final private  String r2 = "山";
    final private  String r3 = "云";
    ...
    private static final String IMAGEVIEW_TAG2 = "山";
    private static final String IMAGEVIEW_TAG3 = "云";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question = findViewById(R.id.GuanShanYue);
    ...
    protected class mySubmitListener implements View.OnClickListener{
        ...
        public void onClick(View v){
            if(s1.equals(r1)&&s2.equals(r2)&&s3.equals(r3)){
                ...
                Toast.makeText(Question8.this, "Wrong answer, please try again.", Toast.LENGTH_LONG).show();
            }
    ...
    protected  class myPreviousListener implements  View.OnClickListener{
        @Override
        public void onClick(View v) {
            startActivity(new Intent(Question8.this,Question7.class));
            finish();
        }
    }
