...
public class Question5 extends AppCompatActivity {
    ...
    final private  String r1 = "莫";
    final private  String r2 = "云";
    final private  String r3 = "尽";

    private FrameLayout hole1;
    private FrameLayout hole2;
    private FrameLayout hole3;

    private static final String IMAGEVIEW_TAG1 = "莫";
    private static final String IMAGEVIEW_TAG2 = "云";
    private static final String IMAGEVIEW_TAG3 = "尽";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question = findViewById(R.id.SongBie);
    ...
    protected class mySubmitListener implements View.OnClickListener{
        ...
        public void onClick(View v){
            if(s1.equals(r1)&&s2.equals(r2)&&s3.equals(r3)){
                ...
                Toast.makeText(Question5.this, "Wrong answer, please try again.", Toast.LENGTH_LONG).show();
            }
